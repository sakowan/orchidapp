...
export const SubscribeNewsletter = (openDialogue) => {
  const [open, setOpen] = useState(true);
  const handleOpen = () => setOpen(!open);

  return (
    <ThemeProvider value={newsletterTheme}>
      <Dialog open={open} handler={handleOpen} className="h-100 outline-none overflow-hidden">
        ...
        <div className="relative z-10 flex">
          <div className="w-3/5 p-6 flexx items-center justify-center">
            ...
            <div className="relative border border-colour-3 rounded-lg overflow-hidden">
              ...
              <div className="absolute top-0 right-0 w-12 h-10 bg-colour-1 border-l border-colour-3 flex items-center justify-center">
