...
const Home = () => {
  ...
  return (
    <div className="w-screen h-screen flex flex-col">
      <div className='flex justify-center mx-auto relative top-[8rem] w-[98%] h-3/4 bg-white animate-zoomOut'>
      ...
      <div id="banner2" className="flex justify-center w-[98%] h-3/4 mx-auto mt-[10rem] border border-gray-400">
